...
function wa(isi) 
{
	open("https://wa.me/6282142975976?text=Makasih ya udah inget hari ulang tahun aku, di hari spesial ini aku mau " + isi)
}
...
async function makeawish() 
{
	var {
		...
		imageUrl: 'assets/img/makeawish2.jpg',
	...
	if (kado) {
		await swal.fire({
			...
			title: 'Kirim jawabannya ke wa Hua Cheng(Koh Aceng)?',
			confirmButtonColor: '#2fe965',
			confirmButtonText: 'Kirim ✈'
		})
		wa(kado)
